...
const ActionItem: React.FC<ActionItemProps> = ({ icon: Icon, text }) => (
  <div className="w-full flex flex-col items-center group">
    <Icon className="text-4xl text-gray-300 group-hover:text-white duration-300" />
...
export default React.memo(BannerBottom);
